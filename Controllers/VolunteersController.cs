...
namespace APPR.Controllers
{
    public class VolunteersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VolunteerId,FullName,ContactInfo,Skills")] Volunteer volunteer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VolunteerId,FullName,ContactInfo,Skills")] Volunteer volunteer)
        {
